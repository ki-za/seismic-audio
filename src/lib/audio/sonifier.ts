...
import { applyFocus, makeSaturationCurve, measureRms, prepareSamples, dbToGain } from '$lib/domain/sonification';
...
function configureChain(
	...
	nodes.shaper.curve              = makeSaturationCurve(mode === 'soft' ? 1.4 : mode === 'clear' ? 2.2 : mode === 'deep' ? 1.8 : mode === 'bright' ? 2.6 : 1.1) as Float32Array<ArrayBuffer>;
